...
namespace Fresnel.Core
{
	...
	public interface IFresnelCalculator
	{
		...
		double Radius1(double frequencyHz, double d1Meters, double d2Meters)
		{
			return RadiusN(1, frequencyHz, d1Meters, d2Meters);
		}
	}
	...
	public static class GeoUtils
	{
		...
		{
			return new GeoPoint(a.LatitudeDeg + (b.LatitudeDeg - a.LatitudeDeg) * t,
